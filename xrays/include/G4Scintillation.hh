...
class G4Scintillation : public G4VRestDiscreteProcess
{
 public:
  ...
  void SetResolutionFromFunction(const G4bool);
  // Called by the user to set the resolution scale as a function
  // of energy deposited, rather than a constant

  G4bool GetResolutionFromFunction() const;
  // Return the boolean for whether resolution scale is set
  // from a function
